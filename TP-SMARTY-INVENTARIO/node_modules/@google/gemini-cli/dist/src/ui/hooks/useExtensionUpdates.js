...
export const useExtensionUpdates = (extensions, extensionEnablementManager, addItem, cwd) => {
    ...
    useEffect(() => {
        ...
        if (extensionsToCheck.length === 0)
            return;
        checkForAllExtensionUpdates(extensionsToCheck, extensionEnablementManager, dispatchExtensionStateUpdate, cwd);
    }, [
        extensions,
    ...
    useEffect(() => {
        ...
        for (const extension of extensions) {
            ...
            if (!shouldUpdate) {
                ...
                const updatePromise = updateExtension(extension, extensionEnablementManager, cwd, (description) => requestConsentInteractive(description, addConfirmUpdateExtensionRequest), currentState.status, dispatchExtensionStateUpdate);
