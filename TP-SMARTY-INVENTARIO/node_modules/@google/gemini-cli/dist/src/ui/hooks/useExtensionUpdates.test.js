...
describe('useExtensionUpdates', () => {
    ...
    it('should check for updates and log a message if an update is available', async () => {
        ...
        const addItem = vi.fn();
        const cwd = '/test/cwd';
        vi.mocked(checkForAllExtensionUpdates).mockImplementation(async (_extensions, _extensionEnablementManager, dispatch, _cwd) => {
            dispatch({
                type: 'SET_STATE',
                payload: {
                    name: 'test-extension',
        ...
        renderHook(() => useExtensionUpdates(extensions, new ExtensionEnablementManager(), addItem, cwd));
        await waitFor(() => {
    ...
    it('should check for updates and automatically update if autoUpdate is true', async () => {
        ...
        renderHook(() => useExtensionUpdates([extension], extensionEnablementManager, addItem, tempHomeDir));
        await waitFor(() => {
            expect(addItem).toHaveBeenCalledWith({
                type: MessageType.INFO,
    ...
    it('should batch update notifications for multiple extensions', async () => {
        ...
        renderHook(() => useExtensionUpdates(extensions, extensionEnablementManager, addItem, tempHomeDir));
        await waitFor(() => {
    ...
    it('should batch update notifications for multiple extensions with autoUpdate: false', async () => {
        ...
        const extensionEnablementManager = new ExtensionEnablementManager();
        renderHook(() => useExtensionUpdates(extensions, extensionEnablementManager, addItem, cwd));
        await waitFor(() => {
