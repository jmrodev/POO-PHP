...
import { EXTENSIONS_CONFIG_FILENAME, INSTALL_METADATA_FILENAME, loadExtension, } from '../extension.js';
...
describe('update tests', () => {
    ...
    describe('updateExtension', () => {
        it('should update a git-installed extension', async () => {
            ...
            const updateInfo = await updateExtension(extension, extensionEnablementManager, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, () => { });
        ...
        it('should call setExtensionUpdateState with UPDATING and then UPDATED_NEEDS_RESTART on success', async () => {
            ...
            await updateExtension(extension, extensionEnablementManager, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, dispatch);
        ...
        it('should call setExtensionUpdateState with ERROR on failure', async () => {
            ...
            await expect(updateExtension(extension, extensionEnablementManager, tempHomeDir, async (_) => true, ExtensionUpdateState.UPDATE_AVAILABLE, dispatch)).rejects.toThrow();
            expect(dispatch).toHaveBeenCalledWith({
                type: 'SET_STATE',
                payload: {
                    name: extensionName,
    ...
    describe('checkForAllExtensionUpdates', () => {
        it('should return UpdateAvailable for a git extension with updates', async () => {
            ...
            const dispatch = vi.fn();
            await checkForAllExtensionUpdates([extension], extensionEnablementManager, dispatch, tempWorkspaceDir);
            expect(dispatch).toHaveBeenCalledWith({
                type: 'SET_STATE',
                payload: {
                    name: 'test-extension',
