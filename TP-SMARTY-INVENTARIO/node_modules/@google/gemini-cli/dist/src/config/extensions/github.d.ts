...
export declare function checkForExtensionUpdate(extension: GeminiCLIExtension, extensionEnablementManager: ExtensionEnablementManager, cwd?: string): Promise<ExtensionUpdateState>;
