...
import { debugLogger, FatalConfigError, GEMINI_DIR, getErrorMessage, Storage, } from '@google/gemini-cli-core';
    ...
    const processScope = (scope) => {
        ...
        if (settings.extensions?.disabled) {
            ...
            for (const extension of settings.extensions.disabled ?? []) {
                disableExtension(extension, scope, extensionEnablementManager, workspaceDir);
            }
